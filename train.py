...
parser = argparse.ArgumentParser(description='Train a SAC model for the tracking problem')
...
if __name__ == "__main__":
    ...
    settings = {'num_cpu': 8,
                ...
                'WandB_entity': 'akanksha_singal',
                'WandB_API_key': '05295dd19a5b535a27611bf3695f3b8b9eb13e22',
                'render': True,
                'eval_episodes': 1,
                'eval_mode': True,
    ...
    if settings['eval_mode']:
        ...
        model_ID = 1732881275
        model_NUMBER = 0
        model = SAC.load(os.path.join("experiments/SAC_{}".format(model_ID), "SAC_{}".format(model_NUMBER)), env=eval_env, device="cpu")
